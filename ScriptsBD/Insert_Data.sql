...
VALUES ('Capuchino', 'café espresso originaria de Italia', 'https://images.unsplash.com/photo-1534778101976-62847782c213?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80', 5.99, 'BEBC', 'activo', GETDATE(), null),
...
('Cupcakes', 'pequeño pastel individual', 'https://images.unsplash.com/photo-1563729784474-d77dbb933a9e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80', 2.15, 'Pos', 'activo', GETDATE(), null),
('frappés', 'bebida helada y espumosa hecha con hielo triturado, café expreso', 'https://img1.wsimg.com/isteam/ip/7b7b9caf-6f41-421f-ab42-97d07f7f833d/eiliv-sonas-aceron-44d0W8JhoPc-unsplash-0001.jpg/:/cr=t:17.53%25,l:17.53%25,w:64.94%25,h:64.94%25', 5.50, 'BEBF ', 'activo', GETDATE(), null),
('sándwiches de jamón y queso', 'Dos rebanadas de pan con jamón y queso en el interior y Tostado', 'https://okdiario.com/img/2019/01/21/receta-de-sandwinch-de-jamon-y-queso-con-mostaza.jpg', 1.25, 'SAN', 'activo', GETDATE(), null),
('Expreso', 'Dos rebanadas de pan con jamón y queso en el interior y Tostado', 'https://okdiario.com/img/2019/01/21/receta-de-sandwinch-de-jamon-y-queso-con-mostaza.jpg', 3.90, 'BEBC', 'activo', GETDATE(), null);
